	...
	public static void runCommand(String command) { // o lastCommand muda pq vc seleciona e dps desseleciona e o sistema executa o comando, e salva ele
		...
		if (args.length == 0) {
			...
			case "version":
				...
				JOptionPane.showMessageDialog(null, Main.PROGRAM_NAME + " " + Texts.version + " " + Main.VERSION + " © Boot 2021, All Rights Reserved.", Texts.version, JOptionPane.INFORMATION_MESSAGE);
				break;
